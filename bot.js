...
client.on("messageUpdate", msg => {
  ...
  client.on("message", msg => {
    //space ab
   db.fetch(`osbirLink_${msg.channel.id}`).then(i => {
    if (i == 'acik') {
   const reklam = ["https", ".xyz", ".net", ".org", ".biz", "http", ".me", ".gg", "www.", ".com", ".io", ".gl", ".az", ".com.tr", ".pv", "net", ".party", ".tk", ".rf.gd",];
